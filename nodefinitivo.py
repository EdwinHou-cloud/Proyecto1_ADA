...
def ConfirmarReserva():
    ...
    for i, reserva in enumerate(reservas_realizadas):
        ...
        for espectador in reserva['espectadores']:
            print(f"  - {espectador.nombre}")
        print(f"Total: ${reserva['total']:.2f}")
    ...
    print(f"\nSubtotal: ${reserva_seleccionada['total']:.2f}")
    ...
    reservas_realizadas[opcion-1]["confirmada"] = True

    # Guardar la reserva confirmada en una lista separada
    ...
    # Guardar la reserva no confirmada en una lista separada
    reservas_no_confirmadas = [reserva for reserva in reservas_realizadas if not reserva["confirmada"]]
    ...
    while True:
        ...
        try:
            ...
            if not agregar_asiento and opcion == 1:
                ...
                reserva_seleccionada['total'] = total
                print(f"\nNuevo total a pagar: ${total:.2f}")
